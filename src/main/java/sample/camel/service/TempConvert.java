...
public class TempConvert extends Service {
    ...
    static {
        URL url = TempConvert.class.getResource("tempconvert.wsdl");
        if (url == null) {
            url = TempConvert.class.getClassLoader().getResource("tempconvert.wsdl");
        }
        if (url == null) {
            java.util.logging.Logger.getLogger(TempConvert.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "tempconvert.wsdl");
        }
        WSDL_LOCATION = url;
    }
